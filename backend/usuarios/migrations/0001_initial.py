# Generated by Django 3.0.7 on 2021-09-21 20:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expertise', models.CharField(choices=[('L', 'Legal'), ('F', 'Financiera')], default='', max_length=1)),
                ('careers', models.CharField(choices=[('abogado', 'Derecho'), ('ingeniero economico', 'Ingeniero en economia'), ('Ingeniero industrial', 'Ingeniero industrial'), ('Ingeniero informatico', 'Ingeniero en informatica')], default='', max_length=100)),
